...
# Jerm Service
variable "jerm_instance_type" {
  type        = string
  description = "EC2 instance type for Jerm's Server"
  default     = "t2.micro"
}

variable "jerm_associate_public_ip_address" {
  type        = bool
  description = "Associate a public IP address to the Jerm's EC2 instance"
  default     = true
}

variable "jerm_root_volume_size" {
  type        = number
  description = "Volumen size of root volumen of Jerm's Server"
}

variable "jerm_root_volume_type" {
  type        = string
  description = "Volumen type of root volumen of Jerm's Server."
  default     = "gp2"
}
